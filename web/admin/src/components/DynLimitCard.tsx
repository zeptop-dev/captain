...
interface Settings { enabled: boolean; trigger_mbps: number; trigger_seconds: number; limit_mbps: number; limit_seconds: number; windows: string[]; whitelist: number[] }
...
export function DynLimitCard() {
  ...
  const form = useForm<Settings>({ initialValues: { enabled: false, trigger_mbps: 100, trigger_seconds: 60, limit_mbps: 30, limit_seconds: 600, windows: [], whitelist: [] } })
